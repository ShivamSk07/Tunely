          ...
          <div className="flex-1 text-center md:text-left space-y-4">
            ...
            <div className="flex items-center justify-center md:justify-start gap-3 pt-2">
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-[#6C63FF] hover:bg-[#6C63FF]/90 text-white text-xs font-bold uppercase tracking-wider rounded-xl transition purple-glow hover:scale-[1.02] active:scale-[0.98]"
              >
                <Play size={15} className="fill-white" /> Play All
              </button>
              <button
                onClick={() => handlePlayAll(true)}
                className="flex items-center gap-2 px-5 py-3 bg-[#12121E] hover:bg-gray-800 text-gray-300 hover:text-white text-xs font-bold uppercase tracking-wider rounded-xl border border-gray-800 transition hover:scale-[1.02] active:scale-[0.98]"
              >
